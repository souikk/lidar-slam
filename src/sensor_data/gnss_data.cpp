 ...
 * @LastEditTime: 2022-09-06 19:15:07
 * @Description:
 */
...
namespace localization
{
    ...
    bool GnssData::syncPointCloud(double timestamp, std::deque<GnssData> &gnss_buf, GnssData &sync_gnss_data)
    {
        ...
        {
            LOG(WARNING) << "current point cloud can not sync gnss.";
        ...
        {
            LOG(WARNING) << "diff time bewteen current point cloud and gnss is too large.";
            return false;
        }
