 ...
 * @LastEditTime: 2022-09-06 19:14:49
 * @Description:
 */
...
namespace localization
{
    ...
    bool ImuData::syncPointCloud(double timestamp, std::deque<ImuData> &imu_buf, ImuData &sync_imu_data)
    {
        ...
        {
            LOG(WARNING) << "current point cloud can not sync imu.";
            return false;
        }
        ...
        {
            LOG(WARNING) << "diff time bewteen current point cloud and imu is too large.";
            return false;
        }
